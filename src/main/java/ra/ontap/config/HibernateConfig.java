...
@Configuration
@PropertySource("classpath:application.properties") // đọc file cấu hình từ tệp properties trong thư mục resource
...
public class HibernateConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setDriverClassName(environment.getRequiredProperty("hibernate.driver-classname"));
